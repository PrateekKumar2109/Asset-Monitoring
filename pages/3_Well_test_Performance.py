...
st.title(f"Count of WELL STRING values based on filters")
st.write(filtered_data['WELL STRING'].value_counts())
...
for well_string in well_strings:
    ...
    well_data = filtered_data[filtered_data['WELL STRING'] == well_string]
